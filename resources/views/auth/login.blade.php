                        ...
                        <div class="loginarea__wraper">
                            ...
                            <form method="POST" action="{{route ('login')}}">
                                ...
                                <div class="loginarea__form">
                                    ...
                                    <input id="email" class="common__login__input @error('email') is-invalid @enderror" type="email" placeholder="Your username or email"  name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                ...
                                <div class="loginarea__form">
                                    ...
                                    <input id="password" class="common__login__input @error('password') is-invalid @enderror" type="password" placeholder="Password" name="password" required autocomplete="current-password">
